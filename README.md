...
## 3- Bicycle Generative Adversarial Network (BiCycleGAN)
...
## 5- Cycle-Consistent Generative Adversarial Network (CycleGAN)
...
## 6- Wasserstein Generative Adversarial Networks (Wasserstein GANs)
